"""change schemas of product

Revision ID: 34924689dc44
Revises: 744f99817ca1
Create Date: 2025-09-10 13:06:49.906897
...
revision: str = '34924689dc44'
down_revision: Union[str, Sequence[str], None] = '744f99817ca1'
...
def upgrade() -> None:
    ...
    op.add_column('transaction_items', sa.Column('discount_per_unit', sa.Numeric(precision=12, scale=2), nullable=False))
