...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground h-10 w-full items-center justify-center rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-accent data-[state=active]:text-white dark:data-[state=active]:bg-accent dark:data-[state=active]:text-black data-[state=active]:shadow-lg",
        // Default text
